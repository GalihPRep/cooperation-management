        ...
        <form action="{{ route('documents.update', $item->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input id="partner" name="partner" type="hidden"
                    value="{{ old('partner', $item_partners) }}">
            ...
            <div class="mb-3">
                ...
                <select id="category_id" name="category_id" class="form-select">
                    ...
                    <option value="{{ $x->id }}"
                        {{ old('category_id', $item->category?->id) == $x->id ? 'selected' : '' }}>
                        {{ $x->name }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <textarea id="scope" name="scope" class="form-control @error('scope') is-invalid @enderror">{{ old('scope', $item->scope) }}</textarea>
            ...
            <div class="mb-3">
                ...
                <input id="signing" name="signing" type="date" class="form-control @error('signing') is-invalid @enderror"
                    value="{{ old('signing', $item->signing) }}">
            ...
            <div class="mb-3">
                ...
                <select id="status_id" name="status_id" class="form-select">
                    ...
                    <option value="{{ $x->id }}"
                        {{ old('status_id', $item->status?->id) == $x->id ? 'selected' : '' }}>
                        {{ $x->name }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <select id="format_id" name="format_id" class="form-select">
                    ...
                    <option value="{{ $x->id }}"
                        {{ old('format_id', $item->format?->id) == $x->id ? 'selected' : '' }}>
                        {{ $x->name }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <input id="division" name="division" type="hidden"
                    value="{{ old('division', $item_divisions) }}">
