...
<div class="mb-3">
    <h1>K/L/PD/badan·hukum/perorangan</h1>
    <a href="/sectors/create" role="button" class="btn btn-primary">Buat K/L/PD/badan·hukum/perorangan</a>
</div>
                ...
                <table class="table table-bordered table-striped align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $x->name }}</td>
                            <td>
                                <a href="sectors/{{ $x->id }}/edit" class="btn btn-primary"><i class="bi bi-pencil-square"></i></a>
                                <form action="/sectors/{{ $x->id }}" method="post" style="display:inline;">
                                    @csrf
                                    @method("delete")
